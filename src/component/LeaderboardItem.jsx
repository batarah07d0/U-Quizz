...
export function LeaderboardItem(props) {
  return (
    <div className="flex justify-between gap-4 bg-gradient-to-br from-[#4EA8DE] to-[#5E60CE] rounded-xl p-4 w-4/5 lg:w-[50rem] mx-auto border-2 border-white scale-90 hover:scale-100 transition ease-in-out hover:border-[#fedf52]">
